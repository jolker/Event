...
public class EventFilteringHandler {
	private static EventFilteringHandler instance = null;
	public static EventFilteringHandler getInstance() {
		if (instance == null) {
			synchronized(EventFilteringHandler.class) {
				instance = new EventFilteringHandler();
				GA.app.info("created singleton = " + EventFilteringHandler.class.getCanonicalName());
			}
		}
		return instance;
	}
	...
	public EventFilteringHandler() {
		userDAO = UserDAOImpl.getInstance();
		giftsDAO = GiftsDAOImpl.getInstance();
	}


	public void onEventFiltering(TransactionFrame tFrame, EventFilter filter, PageView<LuckyBoxEvent> pv) throws Exception {
