...
<#include "head.ftl">
            ...
            <div class="content-wrapper">
              <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h4>
                        <a href="/homepoint"><span class="glyphicon glyphicon-home"></span> Home</a> > Event Manager
                        </h4>
                    </section>
    ...
    <!-- Main content -->
                <section class="content">
                    <div class="container-fluid">
                        <a class="btn btn-primary" href='/eventpoint'><i class="fa fa-plus-circle" aria-hidden="true"></i> Create Event</a>
                ...
                <#if list_event??>
								...
								<#else>
                                        <tr >
                                            ...
                                            <td colspan="6">No result please click  "Create Event" to create</td>
  ...
  <#include "footer.ftl">
            ...
            <!-- ./wrapper -->
<#include "script.ftl">
        <script src="${root_url}custom/js/homePointPage.js"></script>
        </body>
    </html>
